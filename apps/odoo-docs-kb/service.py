"""
Odoo 18 Documentation RAG Service

FastAPI service for retrieval-augmented generation over Odoo 18 docs.
...
INDEX_NAME = os.environ.get("AZURE_SEARCH_INDEX_NAME", "odoo18-docs")
...
async def answer_with_citations(req: AnswerRequest):
    ...
    system_prompt = (
        "You are an Odoo 18 documentation expert. Answer questions using ONLY "

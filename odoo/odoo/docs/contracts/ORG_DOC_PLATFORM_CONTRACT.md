...
| Sources | Odoo 19 docs, Azure platform docs, Databricks docs |
...
| `odoo19-docs` | Odoo 19 CE documentation | Operational |
...
- `agents/knowledge/odoo19_docs/` -- existing eval queries

---
name: odoo18-git-guidelines
description: Odoo 18 git commit guidelines covering message structure, commit tags, format rules, module naming, and WHY vs WHAT in descriptions
metadata:
...
```
[REL] all: release 18.0
```

```
[REL] sale: bump version to 18.0.2.0
```
...
```
[MERGE] sale: forward port fixes from 17.0 to 18.0

Forward port of bug fixes for sale order tax computation
and discount handling from the 17.0 stable branch.
```

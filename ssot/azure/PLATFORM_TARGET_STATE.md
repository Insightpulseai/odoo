...
| --------------- | ----- | --------------------------------------- | -------------------------- | -------- |
| `@` (apex)      | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Root domain                | Active   |
| `www`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | WWW redirect               | Active   |
| `erp`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Odoo ERP                   | Active   |
| `n8n`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | n8n automation             | Active   |
| `auth`          | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Auth service               | Active   |
| `superset`      | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Apache Superset            | Active   |
| `mcp`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | MCP coordinator            | Active   |
| `plane`         | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Plane project mgmt         | Active   |
| `shelf`         | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Shelf service              | Active   |
| `crm`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | CRM service                | Active   |
| `ops`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | Ops console                | Active   |
| `ocr`           | CNAME | `afd-ipai-dev-ep-h6gcfyafbug5dcdb.z03.azurefd.net` | OCR service                | Active   |

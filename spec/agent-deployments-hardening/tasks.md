# Agent Deployments Hardening Tasks

- [ ] AD-01: Write Spec bundle in `spec/agent-deployments-hardening/`
- [ ] AD-02: Write SSOT bindings (`runtime_profiles.yaml`, `environment_matrix.yaml`, schemas, `health_contract.yaml`)

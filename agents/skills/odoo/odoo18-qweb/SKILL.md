---
name: odoo18-qweb
description: Odoo 18 QWeb templating engine — directives, inheritance, data output, loops, conditionals, attributes, sub-templates, JS and Python specifics
metadata:

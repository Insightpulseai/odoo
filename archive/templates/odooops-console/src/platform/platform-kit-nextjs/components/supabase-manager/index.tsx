...
import { LogoSupabase } from '@/platform/platform-kit-nextjs/components/logo-supabase'
import { AuthManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/auth'
import { DatabaseManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/database'
import { LogsManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/logs'
import { SecretsManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/secrets'
import { StorageManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/storage'
import { SuggestionsManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/suggestions'
import { UsersManager } from '@/platform/platform-kit-nextjs/components/supabase-manager/users'
import {
  SheetNavigationProvider,
  useSheetNavigation,
} from '@/platform/platform-kit-nextjs/contexts/SheetNavigationContext'
...
function DialogView({ projectRef, isMobile }: { projectRef: string; isMobile?: boolean }) {
  ...
  const activeManager = stack.length > 0 ? stack[0]?.title ?? null : null

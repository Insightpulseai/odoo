...
SMTP_USER="${MAIL_USER:-postmaster@mg.insightpulseai.com}"
SMTP_PASSWORD="${MAIL_PASSWORD:-}"
MAIL_FROM="${MAIL_DEFAULT_FROM:-noreply@mg.insightpulseai.com}"
...
echo "       • DKIM-Signature: should show d=mg.insightpulseai.com"
...
echo ""
echo "✓ DKIM-Signature:"
echo "  d=mg.insightpulseai.com"
echo "  s=pic"
echo "  Result: pass"
echo ""
echo "✓ SPF:"
echo "  Return-Path: <postmaster@mg.insightpulseai.com>"
echo "  Result: pass"
echo ""
echo "✓ DMARC:"
echo "  From: noreply@mg.insightpulseai.com"
...
echo ""
echo "If DKIM fails:"
echo "  - Verify DNS DKIM record with: dig +short TXT pic._domainkey.mg.insightpulseai.com"
echo "  - Ensure record starts with 'v=DKIM1;'"
echo "  - Check Mailgun dashboard for DKIM verification status"
echo ""
echo "If SPF fails:"
echo "  - Verify DNS SPF record with: dig +short TXT mg.insightpulseai.com"
echo "  - Ensure record includes 'include:mailgun.org'"
echo "  - Check that Return-Path domain matches mg.insightpulseai.com"
echo ""
echo "If DMARC fails:"
echo "  - Verify DNS DMARC record with: dig +short TXT _dmarc.mg.insightpulseai.com"
...
echo "  - Check Mailgun logs at https://app.mailgun.com/app/sending/domains/mg.insightpulseai.com/logs"

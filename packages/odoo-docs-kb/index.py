"""
Odoo 18 Documentation Indexer

Azure AI Search index manager per agents/knowledge/odoo18_docs/indexing.yaml.
...
class AzureSearchIndexer:
    """Manage Azure AI Search index for Odoo 18 docs."""

    def __init__(
        self,
        config_path: str = "agents/knowledge/odoo18_docs/indexing.yaml",
    ):
        ...
        self.manifest_path = self.config.get("incremental", {}).get(
            "tracking", {}
        ).get("manifest_path", "agents/knowledge/odoo18_docs/.index_manifest.json")
    ...
    def ensure_index(self) -> None:
        ...
        fields = [
            ...
            SearchField(
                ...
                vector_search_profile_name="odoo18-vector-profile",
            ),
            SimpleField(
                name="path",
                type=SearchFieldDataType.String,
        ...
        vector_search = VectorSearch(
            algorithms=[
                HnswAlgorithmConfiguration(name="odoo18-hnsw"),
            ],
            profiles=[
                VectorSearchProfile(
                    name="odoo18-vector-profile",
                    algorithm_configuration_name="odoo18-hnsw",
                ),
            ],
        )

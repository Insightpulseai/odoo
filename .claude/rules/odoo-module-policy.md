...
# Custom Module Decision Framework & Enterprise Parity

> When to build custom modules, EE parity strategy, certification workflow.
...
**Target**: Achieve >=80% Odoo Enterprise Edition feature parity via CE + OCA + ipai_* modules.

**Current verified parity**: ~35-45% (audited 2026-03-08). Most implemented modules lack test coverage.
...
1. **P0 - Critical**: Bank Reconciliation, Financial Reports, Payroll, Approvals, BIR Compliance
2. **P1 - High**: Helpdesk, Planning, Timesheet, Asset Management
3. **P2 - Medium**: Documents, Knowledge, Spreadsheet integration
4. **P3 - Low**: IoT, VoIP, advanced Marketing Automation
...
6. CERTIFY    -> Add to parity matrix
```

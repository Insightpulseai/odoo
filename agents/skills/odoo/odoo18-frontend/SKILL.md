---
name: odoo18-frontend
description: Odoo 18 frontend framework — SPA architecture, registries, services, hooks, patching, domains, translation, field widgets
metadata:
...
titleService.setParts({ odoo: "Odoo 18", fruit: "Apple" });
// title = "Odoo 18 - Apple"
...
// Read parts
titleService.getParts();  // { odoo: "Odoo 18" }
```

---
name: odoo18-testing
description: Odoo 18 Testing - Python unit tests, JS unit tests (HOOT), Tours, Form helper, test tags, web_test_helpers, mock_server
metadata:
...
Comprehensive reference for Odoo 18 testing: Python unit tests (TransactionCase,

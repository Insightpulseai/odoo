...
import type { RunbookPlan, Integration } from "@ops-control-room/core";
...
export function RunbookCard({ plan, onRun, onEdit, ButtonComponent }: RunbookCardProps) {
  ...
  return (
    <div className="bg-slate-50 border-2 border-slate-200 rounded-xl overflow-hidden">
      ...
      <div className="px-5 py-4 bg-white border-t border-slate-200 flex gap-3">
        ...
        >
          <Edit3 className="h-4 w-4 mr-2 inline-block" />
          Edit
        </Button>
      </div>
    </div>

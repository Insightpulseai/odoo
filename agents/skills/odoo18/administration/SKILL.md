...
# Administration -- Odoo 18.0 Skill Reference
...
- **PostgreSQL 13 minimum** required (was 12 in Odoo 16/17).
- **Python 3.10+ minimum** (unchanged from 17.0).
- **Odoo 18.0 standard support** runs through September 2027.
...
<!-- TODO: Specific feature-level breaking changes vs 17.0 not enumerated in admin docs -->

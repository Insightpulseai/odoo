---
name: odoo18-actions
description: Odoo 18 Actions - Window, URL, Server, Report, Client, Scheduled Actions (ir.cron), Bindings
metadata:
...
Comprehensive reference for Odoo 18 action types: Window Actions (ir.actions.act_window),

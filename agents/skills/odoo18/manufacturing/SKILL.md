...
metadata:
  author: Claude Agent
  version: "18.0"
  source: "Odoo 18.0 Official Documentation"
  extracted: "2026-02-18"
---

# Manufacturing — Odoo 18.0 Skill Reference
...
<!-- TODO: not found in docs — Odoo 18 manufacturing docs do not cover JSON-RPC or XML-RPC examples directly. -->
...
- **Shop Floor module** replaces the legacy tablet view from earlier versions (available since 16.4, refined in 18.0).
- **Inventory valuation for manufactured products** follows the new 18.0 valuation model: journal entries at invoice level, not per stock move. See Inventory SKILL.md for details.
...
<!-- TODO: specific breaking model/field changes between 17.0 and 18.0 not documented in RST source -->

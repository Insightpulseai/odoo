...
1. **Agent Registry** — register all AI agents (Codex, Pulser, Copilot) in Entra
...
- `.Codex/rules/security-baseline.md` — Secrets policy
- `.Codex/commands/entra-manage.md` — Entra tenant management command

...
def load_manifest():
    ...
    return {
        ...
        "providers": {
            "azure": {
                "iconLibrary": "https://github.com/jgraph/drawio-libs/tree/master/azure"
            },
            "digitalocean": {"iconLibrary": "custom"},
            "kubernetes": {
                "iconLibrary": "https://github.com/jgraph/drawio-libs/tree/master/kubernetes"
            },
            "aws": {
                "iconLibrary": "https://github.com/jgraph/drawio-libs/tree/master/aws"
            },
            "gcp": {
                "iconLibrary": "https://github.com/jgraph/drawio-libs/tree/master/gcp"
            },
        },
        "githubIntegration": {
            "org": "jgtolentino",
...
"""
    ...
    for diag in manifest["diagrams"]:
        ...
        readme_content += (
            f"| {diag['title']} | {providers} | {updated} | {drawio_link} |\n"
        )
...
def main():
    parser = argparse.ArgumentParser(
        description="Update architecture diagrams manifest"
    )
    ...
    parser.add_argument(
        "--provider", type=str, default="generic", help="Provider for the diagram"
    )

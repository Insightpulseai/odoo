...
- [ ] **2. Standardize the Dev Loop:** Publish `.devcontainer` definitions for both Odoo development and Azure Infrastructure development to guarantee AI agent and human developer determinism.

...
| `/search` | POST | None (internal) | Hybrid vector+text search over Odoo 19 docs |
...
| `AZURE_SEARCH_INDEX_NAME` | Index name (default: `odoo19-docs`) | No |
...
|------------|--------|--------|---------|-----------|
| `odoo19-docs` | Active (service exists, 7224 chunks) | `odoo/documentation` 19.0 branch (RST) | `packages/odoo-docs-kb/chunker.py` | text-embedding-ada-002 (1536d) |
...
| `search_odoo_docs` | `_execute_search_odoo_docs` | KB: Odoo 19 docs (grounded RAG) |

...
| `odoo/` | ODOO_RUNTIME, ODOO18_BASELINE_POLICY, ODOO_RUNTIME_VERIFICATION_MATRIX, ODOO_LOCAL_VS_AZURE_PROD, ODOO_UPSTREAM_*, ODOO_COPILOT_*, ODOO_ON_AZURE_*, EXPENSE_LIQUIDATION_INSTALL_MATRIX, OUR_ODOOSH_AZURE_VS_CLOUDPEPPER | 12 |
...
| `identity/` | ENTRA_TARGET_STATE_2026, ENTRA_GOVERNANCE_BASELINE, identity_and_secrets, ODOO_18_AZURE_OAUTH_REFERENCE | 4 |

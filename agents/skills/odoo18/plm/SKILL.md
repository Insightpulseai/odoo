...
<!-- TODO: not found in docs — Odoo 18 PLM docs do not cover JSON-RPC or XML-RPC examples directly. -->
...
- **Rebase functionality**: Concurrent ECO conflict resolution via `Apply Rebase` is a mature feature in 18.0.

<!-- TODO: specific breaking changes between 17.0 and 18.0 not documented in PLM RST source -->

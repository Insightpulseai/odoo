...
| **Odoo CE 18** | Transactional SoR: approvals, accounting, expenses, documents, projects | Reason about data (that's Foundry/Pulser) or extract from images (that's Doc Intel) |

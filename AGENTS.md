# AGENTS.md — InsightPulse AI Monorepo

> Slim index. All heavy detail lives in `.Codex/rules/` files (auto-loaded by Codex).
...
See `.Codex/rules/security-baseline.md` for full policy (sections 2.1-2.6).
...
| Topic | Location |
|-------|----------|
| Directory structure & inventory | `.Codex/rules/repo-topology.md` |
| Architecture, Docker, integrations | `.Codex/rules/platform-architecture.md` |
| Secrets policy, GHAS, allowed tools | `.Codex/rules/security-baseline.md` |
| GitHub governance, CI/CD, PR rules | `.Codex/rules/github-governance.md` |
| Enterprise parity strategy & tables | `.Codex/rules/ee-parity.md` |
| Odoo CE 18 rules, modules, testing | `.Codex/rules/odoo-rules.md` |
| Supabase usage & activation | `.Codex/rules/supabase-usage.md` |
| BIR compliance (PH tax/payroll) | `.Codex/rules/bir-compliance.md` |
| MCP Jobs system | `.Codex/rules/mcp-jobs.md` |
| n8n automations & Codex integration | `.Codex/rules/automations.md` |
| Spec kit structure & bundles | `.Codex/rules/spec-kit.md` |
| Vercel observability & Figma | `.Codex/rules/vercel-observability.md` |
| SSOT platform rules | `.Codex/rules/ssot-platform.md` |

...
> Canonical jobs and observability backend — architecture, components, integration patterns, deployment, monitoring.
...
All LLM calls from MCP Jobs workers **MUST** route through Vercel AI Gateway for centralized model management. See `docs/infra/VERCEL_AI_GATEWAY_INTEGRATION.md`.

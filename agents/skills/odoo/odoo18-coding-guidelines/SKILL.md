---
name: odoo18-coding-guidelines
description: Odoo 18 coding guidelines for module structure, file naming, XML IDs, Python conventions, JavaScript, and CSS/SCSS naming
metadata:

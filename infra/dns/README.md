...
**Output**:
```
🔄 Generating DNS artifacts from SSOT...
...
✅ DNS artifacts generated successfully!
```
...
**Outcome**:
- ✅ Pass: Generated files match committed files
- ❌ Fail: Manual edits detected, run generator and commit

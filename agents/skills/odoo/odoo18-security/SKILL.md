---
name: odoo18-security
description: Odoo 18 Security - Access Rights, Record Rules, Field Access, Groups, Security Pitfalls, SQL injection prevention
metadata:
...
Comprehensive reference for Odoo 18 security mechanisms: Access Rights (ir.model.access),

# SKILL: Refresh Odoo 18 Knowledge Base (Vendored, Pinned, Indexed)
...
Refresh the **Odoo 18 documentation knowledge base** in a reproducible,
...
This skill is the **only permitted mechanism** to update `docs/kb/odoo18/`.

---

## Preconditions (MUST ALL BE TRUE)

1. Repository is clean (no uncommitted changes under `docs/kb/odoo18/`)
...
- `docs/kb/odoo18/upstream/`
- `docs/kb/odoo18/UPSTREAM_REV.txt`
- Updated `docs/kb/odoo18/UPSTREAM_PIN.json`
...
- `docs/kb/odoo18/manifest.json` (Global manifest of all layers)
- `docs/kb/odoo18/sections.json`
- `docs/kb/odoo18/topics.json`
- `docs/kb/odoo18/skills_coverage.json`
- `docs/kb/odoo18/nav.json` (Navigation tree)
- `docs/kb/odoo18/index.json` (Search index)

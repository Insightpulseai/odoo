# Skill: Odoo 18 Expenses — Feature Map + Automation Plan
...
|--------|------|---------|--------|
| `hr_expense_sequence` | `hr-expense` | Auto-numbering for expense reports | Check 18.0 |
| `hr_expense_cancel` | `hr-expense` | Allow cancellation of posted expenses | Check 18.0 |
| `hr_expense_payment` | `hr-expense` | Payment registration from expense | Check 18.0 |
| `hr_expense_advance_clearing` | `hr-expense` | Cash advance + clearing workflow | Check 18.0 |
| `hr_expense_fleet` | `hr-expense` | Link expenses to fleet vehicles | Check 18.0 |
| `hr_expense_tier_validation` | `hr-expense` | Multi-level approval tiers | Check 18.0 |

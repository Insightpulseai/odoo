---
name: odoo18-module
description: Odoo 18 module manifest structure, all manifest fields, hooks, directory conventions, and module lifecycle
metadata:
...
```python
'version': '18.0.1.0.0',  # Odoo 18, module version 1.0.0
```

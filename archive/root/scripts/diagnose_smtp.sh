...
if [[ $PORT_465_BLOCKED == true ]] && [[ $PORT_587_BLOCKED == true ]] && [[ $PORT_2525_BLOCKED == false ]]; then
    ...
    echo "     docker exec -i odoo-core odoo shell -d odoo_prod < scripts/configure_sendgrid_smtp.py"
    ...
    echo "  3. Configure Odoo:"
    echo "     docker exec -i odoo-core odoo shell -d odoo_prod < scripts/configure_mailgun_smtp.py"
    echo ""

...
**Current Image:** `ghcr.io/jgtolentino/odoo-ce:v0.9.0` ❌ **NOT PRODUCTION-READY**
**Fixed Image:** `ghcr.io/jgtolentino/odoo-ce:v0.9.1` ✅ **PRODUCTION-READY**
...
# Verify push
echo "✅ Image available at: https://github.com/jgtolentino/odoo-ce/pkgs/container/odoo-ce"
```
...
services:
  ...
  odoo:
    image: ghcr.io/jgtolentino/odoo-ce:v0.9.1  # ← UPDATED

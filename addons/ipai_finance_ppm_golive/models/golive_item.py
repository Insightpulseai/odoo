...
class FinancePPMGoLiveItem(models.Model):
    ...
    evidence_url = fields.Char(string='Evidence URL', help='Link to supporting documentation or screenshot')

    # Priority
    is_critical = fields.Boolean(string='Critical', default=False, help='Blocking item for go-live')

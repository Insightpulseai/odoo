---
name: odoo18-data-files
description: Odoo 18 Data Files - XML records, fields, external identifiers, CSV data, shortcuts (menuitem, template, asset)
metadata:
...
Comprehensive reference for Odoo 18 data file formats: XML data files (record, field,

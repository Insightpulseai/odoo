...
2. Odoo 19 CE is the transactional SoR — all posted moves originate here
3. Odoo 19 PH localization (v19) ships 2550Q, SLSP/QAP/SAWT .dat natively — IPAI extends, not rebuilds
...
## What Odoo 19 already provides natively (do not rebuild)

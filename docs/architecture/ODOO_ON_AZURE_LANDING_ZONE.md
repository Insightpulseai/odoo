...
This document defines the landing zone architecture for running Odoo CE 18 + OCA + Azure AI Foundry + Databricks on Azure. It follows the same 5 design areas as the SAP-on-Azure LZA, transposed to the Odoo stack.

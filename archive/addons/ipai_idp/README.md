...
| Diagram | Description |
|---------|-------------|
| [ipai_idp_architecture.drawio](../../docs/arch/ipai_idp_architecture.drawio) | High-level system architecture |
| [ipai_idp_build_deploy_custom_models.drawio](../../docs/arch/ipai_idp_build_deploy_custom_models.drawio) | Build & deploy custom document models (Azure-style) |
| [ipai_idp_pdf_processing.drawio](../../docs/arch/ipai_idp_pdf_processing.drawio) | End-to-end PDF invoice/receipt processing flow |
| [ipai_idp_multi_agent_workflow.drawio](../../docs/arch/ipai_idp_multi_agent_workflow.drawio) | Multi-agent workflow with Anthropic skills pattern |

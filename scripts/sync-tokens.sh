...
# ============================================================================
# Copies tokens.scss from pkgs/ipai-design-tokens to the Odoo theme addon.
...
TOKENS_PKG="${REPO_ROOT}/pkgs/ipai-design-tokens"
...
// Edit pkgs/ipai-design-tokens/tokens.scss and re-run sync script.
// ============================================================================

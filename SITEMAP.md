...
|----------|-------------|
| [System Prompt: The Odoo 18 CE & OCA Architect](.agent/rules.md) | .agent |
...
| [Secret Handling Policy (Claude Agents)](CLAUDE_SECRET_POLICY.md) | . |
...
| [MCP Client Adapters](adapters/README.md) | adapters |
...
| [IPAI Ask AI Assistant](addons/ipai_ask_ai/README.md) | addons/ipai_ask_ai |
| [AFC RAG Integration - Deployment Guide](addons/ipai_ask_ai/README_AFC_RAG.md) | addons/ipai_ask_ai |
| [IPAI BIR Tax Compliance](addons/ipai_bir_tax_compliance/README.md) | addons/ipai_bir_tax_compliance |
| [IPAI CRM - Pipeline Clone](addons/ipai_crm_pipeline/README.md) | addons/ipai_crm_pipeline |
...
| [SAP AFC-Style Month-End Closing Template](addons/ipai_finance_closing/README.md) | addons/ipai_finance_closing |
| [Finance PPM Go-Live Checklist](addons/ipai_finance_ppm_golive/README.md) | addons/ipai_finance_ppm_golive |
...
| [IPAI Platform Permissions](addons/ipai_platform_permissions/README.md) | addons/ipai_platform_permissions |
| [IPAI Platform Theme](addons/ipai_platform_theme/README.md) | addons/ipai_platform_theme |
| [IPAI Platform - Workflow Engine](addons/ipai_platform_workflow/README.md) | addons/ipai_platform_workflow |
| [IPAI Superset Connector](addons/ipai_superset_connector/README.md) | addons/ipai_superset_connector |
| [IPAI TBWA Finance](addons/ipai_tbwa_finance/README.md) | addons/ipai_tbwa_finance |
| [TBWA Backend Theme](addons/ipai_theme_tbwa_backend/README.md) | addons/ipai_theme_tbwa_backend |
| [ipai_web_theme_chatgpt](addons/ipai_web_theme_chatgpt/README.md) | addons/ipai_web_theme_chatgpt |
| [IPAI WorkOS - AFFiNE Clone (Umbrella)](addons/ipai_workos_affine/README.md) | addons/ipai_workos_affine |
| [IPAI Work OS Blocks](addons/ipai_workos_blocks/README.md) | addons/ipai_workos_blocks |
| [IPAI WorkOS - Canvas (Edgeless)](addons/ipai_workos_canvas/README.md) | addons/ipai_workos_canvas |
| [IPAI Work OS Collaboration](addons/ipai_workos_collab/README.md) | addons/ipai_workos_collab |
| [IPAI Work OS Core](addons/ipai_workos_core/README.md) | addons/ipai_workos_core |
| [IPAI Work OS Database](addons/ipai_workos_db/README.md) | addons/ipai_workos_db |
| [IPAI Work OS Search](addons/ipai_workos_search/README.md) | addons/ipai_workos_search |
| [IPAI Work OS Templates](addons/ipai_workos_templates/README.md) | addons/ipai_workos_templates |
| [IPAI Work OS Views](addons/ipai_workos_views/README.md) | addons/ipai_workos_views |
...
| [Secret Management for Claude Agents](docs/SECRET_MANAGEMENT.md) | docs |
...
| [DO Gradient Agent Patterns → IPAI Canonical Mapping (TBWA\SMP)](docs/architecture/DO_GRADIENT_AGENT_PATTERNS_TO_IPAI.md) | docs/architecture |
...
| [MCP Quick Start: 5-Minute Setup](docs/mcp/QUICK_START.md) | docs/mcp |
| [MCP Secrets Management Strategy](docs/mcp/SECRETS_MANAGEMENT.md) | docs/mcp |
| [Unified MCP Strategy: Single Source of Truth Across All Interfaces](docs/mcp/UNIFIED_MCP_STRATEGY.md) | docs/mcp |
...
| [Production Login Fix - Canonical Runbook](docs/ops/PRODUCTION_LOGIN_FIX.md) | docs/ops |
...
| [n8n CLI Management for InsightPulse ERP Finance Automation](notion-n8n-monthly-close/N8N_CLI_README.md) | notion-n8n-monthly-close |
| [n8n Workflow Conventions – Finance Ops / Closing Stack](notion-n8n-monthly-close/WORKFLOW_CONVENTIONS.md) | notion-n8n-monthly-close |
| [Supabase Deployment Guide](notion-n8n-monthly-close/supabase/SUPABASE_DEPLOYMENT.md) | notion-n8n-monthly-close/supabase |
| [Finance Ops Workflows](notion-n8n-monthly-close/workflows/README.md) | notion-n8n-monthly-close/workflows |
...
| [Canonical Local Development Workflow](sandbox/dev/README_CANONICAL.md) | sandbox/dev |
...
| [Addendum: GitHub Enterprise Managed Users (EMU) Integration](spec/azdo-odoo-ica/addendum-github-emu.md) | spec/azdo-odoo-ica |
| [Comparison: GitHub Enterprise vs. Azure Repos for ICA Integration](spec/azdo-odoo-ica/comparison-github-vs-azurerepos.md) | spec/azdo-odoo-ica |
| [Constitution: Azure DevOps + Odoo CE 19 ICA Integration](spec/azdo-odoo-ica/constitution.md) | spec/azdo-odoo-ica |
| [Implementation Plan: Azure DevOps + Odoo CE 19 ICA](spec/azdo-odoo-ica/plan.md) | spec/azdo-odoo-ica |
| [Product Requirements Document: Azure DevOps + Odoo CE 19 ICA](spec/azdo-odoo-ica/prd.md) | spec/azdo-odoo-ica |
| [Tasks: Azure DevOps + Odoo CE 19 ICA Implementation](spec/azdo-odoo-ica/tasks.md) | spec/azdo-odoo-ica |
...
| [Odoo 19 EE-Parity Execution Plan](spec/odoo19-ee-parity/EXECUTION_PLAN.md) | spec/odoo19-ee-parity |
| [Odoo 19 Enterprise Edition Parity Project](spec/odoo19-ee-parity/README.md) | spec/odoo19-ee-parity |
| [Odoo 19 Enterprise Edition Parity - Product Requirements Document](spec/odoo19-ee-parity/prd.md) | spec/odoo19-ee-parity |
...
| [PRD: IPAI Finance PPM (Project Portfolio Management)](specs/003-finance-ppm.prd.md) | specs |
| [003 – Odoo CE Custom Image – Production Artifact Spec](specs/003-odoo-custom-image.prd.md) | specs |
| [InsightPulse ERP – Production Module Installation Sequence](specs/INSTALL_SEQUENCE.md) | specs |
...
| [Extension Architecture](vscode-extension/ARCHITECTURE.md) | vscode-extension |
| [Odoo Live Sandbox - Agent Dev Cockpit](vscode-extension/README.md) | vscode-extension |
...
| [Finance PPM n8n Workflows - Deployment Guide](workflows/finance_ppm/DEPLOYMENT.md) | workflows/finance_ppm |
| [Finance PPM n8n Workflows - Deployment Summary](workflows/finance_ppm/DEPLOYMENT_SUMMARY.md) | workflows/finance_ppm |
| [Finance PPM Automation - Final Deployment Report](workflows/finance_ppm/FINAL_DEPLOYMENT_REPORT.md) | workflows/finance_ppm |
| [n8n Workflow Import Checklist](workflows/finance_ppm/N8N_IMPORT_CHECKLIST.md) | workflows/finance_ppm |

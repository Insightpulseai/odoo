...
Build a PH-native tax compliance engine that fills the gap between Odoo CE 18 PH localization and enterprise tax platforms (SAP Tax Compliance, AvaTax). Core deliverable: automated BIR 2307 generation from posted Odoo journal entries.
...
| 2550Q (Quarterly VAT) | Odoo 18 native | Extend with ops.artifacts | Phase 2 |
| 1601-EQ (Quarterly EWT Return) | ops.tax_runs aggregation | Filled .xlsx | Phase 2 |
| SLSP .dat | Odoo 18 native export | Wire to Supabase Storage | Phase 2 |
| QAP .dat | Odoo 18 native export | Wire to Supabase Storage | Phase 2 |
| SAWT .dat | Odoo 18 native export | Wire to Supabase Storage | Phase 2 |

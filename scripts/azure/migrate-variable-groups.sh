...
echo "2. Grant id-ipai-dev MI access to kv-ipai-dev:"
echo "   az keyvault set-policy --name kv-ipai-dev --object-id 1aee831f-3813-4eed-b49c-f7665330f0f6 --secret-permissions get list"
echo "   # id-ipai-dev: rg-ipai-dev-odoo-runtime / clientId 2d9a8328-c8cb-47fc-ba4e-01c1cf9b75d8"

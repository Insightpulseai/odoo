...
- **Status**: DONE
- **Owner**: Platform team
- **Action**: Assign owner/type/lifecycle to every active repo in `ssot/github/desired-end-state.yaml`
...
- **Deliverable**: GitHub Projects created; `ssot/plane/config.yaml` `project_taxonomy` section
...
- **Deliverable**: `ssot/databricks/workspace.yaml` `maturity_phases` section; Phase 1 active
...
- **Deliverable**: `ssot/governance/enterprise_okrs.yaml` with CI validator
- **Verification**: `python3 scripts/ci/validate_enterprise_okrs.py` passes

## Implementation Tasks

- [x] Phase 1: Create `ssot/governance/enterprise_okrs.yaml`
- [x] Phase 2a: Update `ssot/github/desired-end-state.yaml`
- [x] Phase 2b: Update `ssot/plane/config.yaml`
- [x] Phase 2c: Update `ssot/databricks/workspace.yaml`

...
- [ ] Wire Odoo 18 native 2550Q → ops.artifacts
- [ ] Wire Odoo 18 native SLSP .dat → Supabase Storage
- [ ] Wire Odoo 18 native QAP .dat → Supabase Storage
- [ ] Wire Odoo 18 native SAWT .dat → Supabase Storage

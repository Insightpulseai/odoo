...
5.  **Odoo 18 & 19 Standards:** You write code for Odoo 18 and 19.
    ...
    * **Agentic Workflows:** Follow the reasoning and multi-agent patterns defined in [.agent/skills/ai-agent-patterns/SKILL.md](file:///Users/tbwa/Documents/GitHub/Insightpulseai/odoo/.agent/skills/ai-agent-patterns/SKILL.md). Prioritize ReAct loops and multi-agent consensus for complex tasks.
    * **CI/CD Optimization:** Apply minimal Docker and Testcontainers patterns from [.agent/skills/odoo-ci-optimization/SKILL.md](file:///Users/tbwa/Documents/GitHub/Insightpulseai/odoo/.agent/skills/odoo-ci-optimization/SKILL.md) to accelerate testing.
...
- **Educational:** Explain _why_ you are choosing a specific CE/OCA path over Enterprise.

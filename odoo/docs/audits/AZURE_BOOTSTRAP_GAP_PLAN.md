...
| D3 | Should the workflow build custom images or use stock Odoo? | Custom (Dockerfile.unified) or `docker.io/library/odoo:19.0` | `odoo-runtime.bicep` uses stock image; `deploy-azure.yml` builds custom |

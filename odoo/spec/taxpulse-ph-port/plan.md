...
> 5-phase plan for selective transplant into `ipai_bir_tax_compliance` (Odoo 19.0 CE).
...
3. Port rules engine (`evaluator.py`, `formula.py`, `loader.py`) into `models/rules_engine/`
   ...
   - Adapt to Odoo 19.0 ORM conventions (see `odoo19-coding.md`)

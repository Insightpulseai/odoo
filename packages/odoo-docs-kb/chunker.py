"""
Odoo 18 Documentation Chunker

Heading-aware RST chunker per agents/knowledge/odoo18_docs/chunking.yaml.
...
class RSTHeadingChunker:
    ...
    def __init__(
        self,
        config_path: str = "agents/knowledge/odoo18_docs/chunking.yaml",
    ):

...
<!-- TODO: Specific 17-to-18 breaking changes not found in docs. The documentation reviewed is for the current version without explicit migration notes. -->

- Odoo 18.0 uses Python 3.12+.
